...
func emailCustomerAboutFailedPayment(email string) {
	msg := fmt.Sprintf("Payment processing failed. Could not activate your subscription. Please contact support at support@www.agorascan.io. Manage Subscription: https://" + utils.Config.Frontend.SiteDomain + "/user/settings")
	// escape html

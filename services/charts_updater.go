...
func averageDailyValidatorIncomeChartData() (*types.GenericChartData, error) {
	...
	chartData := &types.GenericChartData{
		...
		XAxisTitle:   "",
		YAxisTitle:   "Average Daily Validator Income [BOA/day]",
		StackingMode: "false",
		Type:         "column",
		Series: []*types.GenericChartDataSeries{
			{
...
func stakingRewardsChartData() (*types.GenericChartData, error) {
	...
	chartData := &types.GenericChartData{
		...
		XAxisTitle:   "",
		YAxisTitle:   "Staking Rewards [BOA]",
		StackingMode: "false",
		Type:         "line",
		Series: []*types.GenericChartDataSeries{
			{
...
func balanceDistributionChartData() (*types.GenericChartData, error) {
	...
	chartData := &types.GenericChartData{
		...
		XAxisTitle:           "Balance",
		YAxisTitle:           "# of Validators",
		XAxisLabelsFormatter: `function(){ return this.value+'BOA' }`,
		StackingMode:         "false",
		Type:                 "column",
		Series: []*types.GenericChartDataSeries{
			{
...
func performanceDistribution1dChartData() (*types.GenericChartData, error) {
  ...
  if (this.value < 0) return '<span style="color:var(--danger)">'+this.value+'BOA<span>'
  return '<span style="color:var(--success)">'+this.value+'BOA<span>'
}
`,
		YAxisTitle:   "# of Validators",
		StackingMode: "false",
...
func depositsChartData() (*types.GenericChartData, error) {
	...
	chartData := &types.GenericChartData{
		Title:        "Deposits",
		Subtitle:     "Daily Amount of deposited BOA.",
		XAxisTitle:   "Income",
		YAxisTitle:   "Deposited BOA",
		StackingMode: "normal",
		Type:         "column",
		Series: []*types.GenericChartDataSeries{
			{
